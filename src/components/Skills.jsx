...
import sk2 from "../assets/node.jpg";
import sk3 from "../assets/next.jpg";
import sk4 from "../assets/ex.jpg";
import sk5 from "../assets/mg.png";
import sk6 from "../assets/java.png";
import sk7 from "../assets/sql.jpg";
        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            {/* <Service
              num="1"
              title="Ui/Ux Design"
              desc="UI/UX is the practice of designing interfaces and experiences that prioritize user satisfaction and engagement in your project. It involves creating intuitive layouts, visually appealing designs, and smooth interactions to ensure a seamless and enjoyable user journey while achieving your project goals."
            ...
            <Service
              ...
              title="Full-Stack Development"
               ...
               Technical Stack Learned: ReactJs, HTML, CSS, JavaScript, Bootstrap, Node js, Express js, MongoDb.
               Done various projects based on web technologies like Responsive React CRUD Operation,Photography Website, Movie booking app, and so on.

    ...
    >
      ...
      <Wrapper>
        ...
        <Div className="text-[40px] md:text-[90px] 2xl:text-[120px] leading-[52px] md:leading-[95px] 2xl:leading-[123px] font-oswald uppercase mb-[25px] md:mb-[40px] 2xl:mb-[60px] flex flex-col relative">
          <span>An Aspiring MERN Developer</span>
        ...
        <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
          As a fresher aspiring to be a MERN developer, I've already completed
          various projects, demonstrating my passion and dedication. my
          eagerness to join a company reflects your strong desire to learn new
          technologies, contribute to meaningful projects, and further develop
          my skills in the MERN stack.
        </Div>
        {/* PARAGRAPH END */}
